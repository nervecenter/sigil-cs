...
namespace Sigil.Services
{
    ...
    public class CountService : ICountService
    {
        ...
        {
            ViewCount viewC = viewCountRepository.GetIssueViewCount(issue.Product.OrgId, issue.Id);
        ...
        {
            VoteCount voteC = voteCountRepository.GetIssueVoteCount(issue.Product.OrgId, issue.Id);
