...
namespace Sigil.Models
{
    ...
    partial void DeleteNotification(Notification instance);
		...
		public System.Data.Linq.Table<CommentCount> CommentCounts
		{
			get
			{
				return this.GetTable<CommentCount>();
			}
		}
		
		public System.Data.Linq.Table<SubCount> SubCounts
		{
			get
			{
    ...
    partial void OnviewsChanged();
		...
		public Topic()
		{
			...
			this._Orgs = new EntitySet<Org>(new Action<Org>(this.attach_Orgs), new Action<Org>(this.detach_Orgs));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Topic_Org", Storage="_Orgs", ThisKey="Id", OtherKey="topicid")]
		public EntitySet<Org> Orgs
		{
			get
			{
				return this._Orgs;
			...
			set
			{
				this._Orgs.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Topic_Image", Storage="_Images", ThisKey="Id", OtherKey="TopicId")]
		...
		private void attach_Orgs(Org entity)
		{
			this.SendPropertyChanging();
			entity.Topic = this;
		}
		
		private void detach_Orgs(Org entity)
		{
			this.SendPropertyChanging();
			entity.Topic = null;
		}
    ...
    partial void OntopicIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Category_Image", Storage="_Images", ThisKey="Id", OtherKey="CatId")]
		public EntitySet<Image> Images
		{
			get
			{
    ...
    partial void OntopicidChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Org_Image", Storage="_Images", ThisKey="Id", OtherKey="OrgId")]
		public EntitySet<Image> Images
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Org_Comment", Storage="_Comments", ThisKey="Id", OtherKey="OrgId")]
		public EntitySet<Comment> Comments
		{
			get
			{
		...
		public Topic Topic
		{
			...
			set
			{
							...
							|| (this._Topic.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Topic.Entity = null;
						previousValue.Orgs.Remove(this);
					}
					this._Topic.Entity = value;
					if ((value != null))
					{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.SubCount")]
	public partial class SubCount : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnOrgIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Org_Comment", Storage="_Org", ThisKey="OrgId", OtherKey="Id", IsForeignKey=true)]
		public Org Org
		{
			get
			{
